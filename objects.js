...
var email = {
  sender: "info@tech.net",
  recipient: "help@tech.net",
  subject: "New user privileges",
  attachment: true,
  content: "Please give all users copier access."
};
...
var email2 = [
  ...
  {
    sender: "billing@boxstore.com",
    recipient: "ap@warehouse.net",
    subject: "Overdue invoice",
    attachment: true,
    content: "Please pay us, your attached invoice is past due."
  },
  {
    sender: "silly@goober.com",
    recipient: "bigboy@comedy.org",
    subject: "got a goof for ya",
    attachment: false,
    content: "joke's on you, I don't have anything funny to say"
  }
];

console.log(Object(email2))